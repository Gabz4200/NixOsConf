...
in {
  ...
  options.theming.stylix = {
    enable = lib.mkEnableOption "Enable Stylix theming and styling configurations";
    unstable = lib.mkEnableOption "Enable unstable theming features and experimental configurations";
  };
