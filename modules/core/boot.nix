...
in {
  ...
  options.core.boot = {
    enable = lib.mkEnableOption "Enable boot configuration and system performance settings";
    unstable = lib.mkEnableOption "Enable unstable boot features and experimental optimizations";
  };
