...
in {
  ...
  options.core.system = {
    enable = lib.mkEnableOption "Enable core system configuration and essential system settings";
    unstable = lib.mkEnableOption "Enable unstable system features and experimental configurations";
  };
